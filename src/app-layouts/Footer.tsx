    ...
    <div className="text-gray-700 body-font">
      ...
      <div className="border-t border-gray-200">
        ...
        <a className="text-gray-500">
          <svg fill="currentColor" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5"
               viewBox="0 0 24 24">
        ...
        <a className="ml-3 text-gray-500">
          <svg fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="2"
        ...
        <a className="ml-3 text-gray-500">
          <svg fill="currentColor" stroke="currentColor" strokeLinejoin="round" strokeWidth="0"
               className="w-5 h-5" viewBox="0 0 24 24">
            <path stroke="none"
