        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <svg fill="currentColor" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"
                 strokeWidth="2" className="w-4 h-4 text-blue-500" viewBox="0 0 24 24">
              <path
            ...
            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                 className="w-4 h-4 text-blue-500" viewBox="0 0 24 24">
              <path
                d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
            </svg>
            ...
            <div className="flex">
              ...
              <Link
                href="https://fast.accesstrade.com.vn/deep_link/5597000641894769237/4751584435713464237?url=https%3A%2F%2Fshopee.vn%2Fproduct%2F89827191%2F2265399926">
                <button
                  className="flex ml-auto text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">Đặt
                  Mua
                </button>
              </Link>
              <button
...
const ProductImages = ({ className }: ProductImageProps) => {
    return (
